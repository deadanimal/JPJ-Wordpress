...
use JCITwig\Extension\GlobalsInterface;
use JCITwig\Extension\StagingExtension;
    ...
    private function initExtension(ExtensionInterface $extension): void
    {
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            if (!$parser instanceof TokenParserInterface) {
                throw new \LogicException('getTokenParsers() must return an array of \JCITwig\TokenParser\TokenParserInterface.');
            }
