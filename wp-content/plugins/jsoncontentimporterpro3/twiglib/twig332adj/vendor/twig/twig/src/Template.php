 ...
 * instead, which returns an instance of \JCITwig\TemplateWrapper.
 *
...
abstract class Template
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true, self $templateContext = null)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \JCITwig\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \JCITwig\Error\LoaderError exceptions
                // see \JCITwig\Error\LoaderError
