...
namespace JCITwig\Profiler\Node;
...
class EnterProfileNode extends Node
{
    ...
    public function compile(Compiler $compiler): void
    {
        $compiler
            ...
            ->raw("];\n")
            ->write(sprintf('$%s->enter($%s = new \JCITwig\Profiler\Profile($this->getTemplateName(), ', $this->getAttribute('var_name'), $this->getAttribute('var_name').'_prof'))
