...
namespace JCITwig\Node;

use JCITwig\Compiler;
use JCITwig\Node\Expression\AbstractExpression;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use JCITwig\Environment;\n")
                ->write("use JCITwig\Error\LoaderError;\n")
                ->write("use JCITwig\Error\RuntimeError;\n")
                ->write("use JCITwig\Extension\SandboxExtension;\n")
                ->write("use JCITwig\Markup;\n")
                ->write("use JCITwig\Sandbox\SecurityError;\n")
                ->write("use JCITwig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use JCITwig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use JCITwig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use JCITwig\Source;\n")
                ->write("use JCITwig\Template;\n\n")
            ;
        }
        $compiler
