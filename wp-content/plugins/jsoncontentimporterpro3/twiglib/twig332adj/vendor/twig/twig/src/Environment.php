...
use JCITwig\Cache\CacheInterface;
use JCITwig\Cache\FilesystemCache;
use JCITwig\Cache\NullCache;
use JCITwig\Error\Error;
...
use JCITwig\Extension\EscaperExtension;
use JCITwig\Extension\ExtensionInterface;
use JCITwig\Extension\OptimizerExtension;
use JCITwig\Loader\ArrayLoader;
use JCITwig\Loader\ChainLoader;
use JCITwig\Loader\LoaderInterface;
use JCITwig\Node\ModuleNode;
use JCITwig\Node\Node;
use JCITwig\NodeVisitor\NodeVisitorInterface;
use JCITwig\RuntimeLoader\RuntimeLoaderInterface;
use JCITwig\TokenParser\TokenParserInterface;
...
class Environment
{
    public const VERSION = '3.3.2.jci';
     ...
     *           a \JCITwig\Cache\CacheInterface implementation,
     ...
     *
     * @return CacheInterface|string|false A JCITwig\Cache\CacheInterface implementation,
     ...
     *
     * @param CacheInterface|string|false $cache A JCITwig\Cache\CacheInterface implementation,
     *                                           an absolute path to the compiled templates,
     *                                           or false to disable cache
     */
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            throw new \LogicException('Cache can only be a string, false, or a \JCITwig\Cache\CacheInterface implementation.');
        }
    }
     ...
     *
     * Similar to load() but it also accepts instances of \JCITwig\Template and
     * \JCITwig\TemplateWrapper, and an array of templates where each is tried to be loaded.
     *
