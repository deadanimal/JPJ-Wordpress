...
var TwigHighlightRules = function() {
	...
	// JCI
	filters = filters + "|wp_get_page_properties|wp_get_cp_by_cpf_keyvalue|wp_get_custom_field_value|wp_insert_custom_field_keyvalue|wp_create_new_custom_post|wp_delete_custom_post|get_data_of_uploaded_file|get_file|base64encode_savefile|jci_db_select|jci_db_insert|jci_db_delete|jci_db_update|jci_db_create|jci_user_create|jci_woo_calc_auth|jci_setcookie|jci_getcookie|jci_forward"; // jci
    tags = tags + "|preg_replace|sortbyarray|html_entity_decode|removenonprintable|htmlentities|htmlspecialchars_decode|base64encode|removespecialcharsinurl|stringshorter|formatnumber|doshortcode|json_decode|json_decode_4twig|mediastore|converthex2ascii|convert2html|dump|md5|sortbyjsonfield|dateformat|matches";  // jci
