...
<div  class="w-full py-8 px-5 bg-white shadow-sm">
    <div class="flex justify-between">
        ...
        <div class=" text-lg">
            ...
            <?php } ?>
            <span class=" text-gray-700">Version:</span> <span class=" text-gray-800">1.9.9</span>
        </div>
    </div>
</div>
...
&lt;?php } ?&gt;
    ...
    <div class=" w-1/4 p-4 shadow-sm flex flex-col justify-center rounded-sm bg-white">
        ...
        <div class="mt-10">
        <iframe src="https://tools.fiverr.com/?searchbox-iframe=1&amp;affid=102069&amp;widget-style=1&amp;delivery-time-flag=show-delivery-time&amp;widget-search-placeholder=WordPress+theme&amp;widget-commission=fiverrhybrid" border="0" scrolling="no" height="341px" width="100%" style="border: 0px; overflow: hidden; width: 663px; max-width: 280px; height: 341px; box-shadow: rgba(17, 17, 17, 0.12) 0px 16px 32px;" class="fasb-iframe-searchbox-widget"  data-origwidth="100%" data-origheight="253px" widget-style="1" delivery-time-flag="show-delivery-time"></iframe>
        </div>
        <p class="mt-2 text-gray-600">(Third party service)</p>
