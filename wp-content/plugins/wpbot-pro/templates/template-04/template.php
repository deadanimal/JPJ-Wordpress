    ...
    <div class="wp-chatbot-container">
        ...
        <div id="wp-chatbot-board-container" class="wp-chatbot-board-container">
            ...
            <div class="wp-chatbot-header-style04">
                ...
                <span id="wp-chatbot-desktop-close" title="<?php echo(get_option('qlcd_wp_chatbot_close_lan') != '' ? get_option('qlcd_wp_chatbot_close_lan') : 'Close'); ?>"><i class="fa fa-times" aria-hidden="true"></i></span>
                <span id="wp-chatbot-desktop-reload" title="<?php echo(get_option('qlcd_wp_chatbot_reset_lan') != '' ? get_option('qlcd_wp_chatbot_reset_lan') : 'Reset'); ?>"><i class="fa fa-refresh" aria-hidden="true"></i></span>
