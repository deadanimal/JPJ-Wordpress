<?php 
global $wpdb,$wpchatbot_pro_professional_init,$wpchatbot_pro_master_init,$wpchatbot_pro_starter_init;
...
<div class="wp-chatbot-wrap">
    ...
    <div class="wpbot_addons_section container">
        <?php 
            if((isset($wpchatbot_pro_master_init) && $wpchatbot_pro_master_init->is_valid()) || (isset($wpchatbot_pro_professional_init) && $wpchatbot_pro_professional_init->is_valid()) || (isset($wpchatbot_pro_starter_init) && $wpchatbot_pro_starter_init->is_valid()) ){
        ?>
                <div class="panel">
                <div class="panel-body">
                <?php echo esc_html__('Please go to the manage modules page to activate your required modules.', 'wpchatbot'); ?><a href="<?php echo esc_attr__(admin_url('admin.php?page=wpbot-modules'), 'wpchatbot');?>">click here</a>
                </div>
            </div>
        ...
        <?php }else { ?>
            ...
            <div class="wpbot_single_addon">
                <div class="wpbot_single_content">
                    <div class="wpbot_addon_image">
                        <img src="<?php echo esc_url(QCLD_wpCHATBOT_PLUGIN_URL.'images/open-ai-logo.png'); ?>" title="" />
                    </div>
                    <div class="wpbot_addon_content">
                        ...
                        <?php if( is_plugin_active( 'chatbot-openai-addon/qcld-bot-openai.php' ) ){
                            ...
                            <p>Open AI Addon for your ChatBot</p>
                            <?php if( is_plugin_active( 'chatbot-openai-addon/qcld-bot-openai.php' ) ){
                                ?>
                                <a class="button button-secondary" href="<?php echo esc_url(admin_url('admin.php?page=wpbot_openAi')); ?>" >Settings</a>
                                <?php
                            }else{
                                ?>
                                <a class="button button-secondary" href="https://www.quantumcloud.com/products/chatbot-addons/" target="_blank" >Get It Now</a>
