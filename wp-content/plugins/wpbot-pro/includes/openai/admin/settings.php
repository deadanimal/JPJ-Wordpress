<div class="row g-0">
    <div class="col-sm-10">
        ...
        <div class="mb-3">
            <label for="max_tokens" id="openai_engines" class="form-label"><?php esc_html_e( 'Open AI model','openai_addon');?></label>
        ...
        <div class="mb-3">
            <label for="qcld_openai_custom_model" class="form-label"><?php esc_html_e( 'Custom Fine Tuned Model','openai_addon');?></label>
            <input id="qcld_openai_custom_model" class="form-control" type="text" name="qcld_openai_custom_model" value="<?php echo get_option( 'qcld_openai_custom_model'); ?>">
