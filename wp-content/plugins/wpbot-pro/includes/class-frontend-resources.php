...
class Qcld_WPBot_Frontend_resources
{
    ...
    public function qcld_wb_chatbot_frontend_scripts()
    {
		...
		if ( is_user_logged_in() ) { 
            ...
            $pm_averter = get_user_meta( $user_id,'pm_user_avatar');
          
            $user_image = !empty($pm_averter) ?  wp_get_attachment_image_url($pm_averter[0]) : esc_url( get_avatar_url( $current_user->ID ) );
		}
