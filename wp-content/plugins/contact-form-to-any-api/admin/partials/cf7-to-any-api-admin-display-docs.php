<div class="cf7anyapi_documentation">
...
Content-Type: application/json
        ...
        <h2><?php esc_html_e( 'CF7 To Any API Video', 'contact-form-to-any-api' ); ?></h2>
        <iframe width="660" height="415" src="https://www.youtube.com/embed/1K-JdXwDH_k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</div>